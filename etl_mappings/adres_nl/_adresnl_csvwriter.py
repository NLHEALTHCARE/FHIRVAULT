...
# with open('mut_pcdata_testje.csv', newline='', encoding='utf-8') as f:
...
# with open('adresnl_tester.csv', 'w', newline='', encoding='utf-8') as f:
...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"""code om het aanvangsbestand van adresnl bestand (8 miljoen regels) in te lezen, dit is slechts eenmalig. Hierna wordt de database telkens
aangepast met kleine update bestanden"""
